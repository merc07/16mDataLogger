...
public class MainActivity extends AppCompatActivity
        ...
        private void displayValue(String value, String result) {
            ...
            switch (valueData) {
                ...
                case 5:
                    ...
                    motorcycleModel = ((int) m) - 65;  // 'A':0 to 'M':12
    ...
    private void navigateToFragment(int menuId) {
        ...
        if (menuId == R.id.nav_startup_view) {
            ...
            // we have motorcycleModel =  'A':0 to 'M':12
          switch (motorcycleModel) {
              ...
              case 3:
                  ...
                  break;
              case 4:
                  bundle.putInt(TableFragment.ARG_RPM_MOT_ID, R.array.rpm_mot_E);
                  bundle.putInt(TableFragment.ARG_TPS_MOT_ID, R.array.tps_mot_E);
                  break;
              case 5:
                  bundle.putInt(TableFragment.ARG_RPM_MOT_ID, R.array.rpm_mot_F);
                  bundle.putInt(TableFragment.ARG_TPS_MOT_ID, R.array.tps_mot_F);
                  break;
              case 6:
                  bundle.putInt(TableFragment.ARG_RPM_MOT_ID, R.array.rpm_mot_G);
                  bundle.putInt(TableFragment.ARG_TPS_MOT_ID, R.array.tps_mot_G);
                  break;
              case 7:
                  bundle.putInt(TableFragment.ARG_RPM_MOT_ID, R.array.rpm_mot_H);
                  bundle.putInt(TableFragment.ARG_TPS_MOT_ID, R.array.tps_mot_H);
                  break;
              case 8:
                  bundle.putInt(TableFragment.ARG_RPM_MOT_ID, R.array.rpm_mot_I);
                  bundle.putInt(TableFragment.ARG_TPS_MOT_ID, R.array.tps_mot_I);
                  break;
              case 9:
                  bundle.putInt(TableFragment.ARG_RPM_MOT_ID, R.array.rpm_mot_J);
                  bundle.putInt(TableFragment.ARG_TPS_MOT_ID, R.array.tps_mot_J);
                  break;
              case 10:
                  bundle.putInt(TableFragment.ARG_RPM_MOT_ID, R.array.rpm_mot_K);
                  bundle.putInt(TableFragment.ARG_TPS_MOT_ID, R.array.tps_mot_K);
                  break;
              case 11:
                  bundle.putInt(TableFragment.ARG_RPM_MOT_ID, R.array.rpm_mot_L);
                  bundle.putInt(TableFragment.ARG_TPS_MOT_ID, R.array.tps_mot_L);
                  break;
              case 12:
                  bundle.putInt(TableFragment.ARG_RPM_MOT_ID, R.array.rpm_mot_M);
                  bundle.putInt(TableFragment.ARG_TPS_MOT_ID, R.array.tps_mot_M);
                  break;
          }
